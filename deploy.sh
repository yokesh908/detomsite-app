...
# The portals are served from their Vercel *.vercel.app hostnames. detomsite.in
# is a separate Vercel project in another account and is NOT deployed from here,
# so it must not be used as FRONTEND_URL or in the CORS allowlist.
FRONTEND_URL="${DETOMSITE_FRONTEND_URL:-https://detomsite-frontend.vercel.app}"
...
set_env ALLOWED_ORIGINS        "[\"$FRONTEND_URL\",\"https://detomsite-student.vercel.app\",\"https://detomsite-admin.vercel.app\",\"https://detomsite-shopkeeper.vercel.app\",\"http://localhost:5173\"]"
