  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'gold-sm': '0 2px 6px rgba(212, 160, 23, 0.20)',
        'gold': '0 4px 14px rgba(212, 160, 23, 0.28)',
        'gold-lg': '0 10px 30px rgba(212, 160, 23, 0.32)',
        'emerald-sm': '0 2px 6px rgba(22, 163, 74, 0.18)',
        'emerald': '0 4px 14px rgba(22, 163, 74, 0.25)',
        'emerald-lg': '0 10px 30px rgba(22, 163, 74, 0.30)',
      },
      borderRadius: {
        'sm': '6px',
        'btn': '8px',
